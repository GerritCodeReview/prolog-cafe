 ...
 *
 * <pre>
 *   '$regex_atom'(+Pattern, +Chars, -Matches)
 * </pre>
 */
public class PRED_$regex_match_3 extends Predicate.P3 {
  ...
  public PRED_$regex_match_3(Term a1, Term a2, Term a3, Operation cont) {
        arg1 = a1;
        arg2 = a2;
        arg3 = a3;
        this.cont = cont;
  ...
  private static final class PRED_regex_check extends Operation {
    ...
    public Operation exec(Prolog engine) {
      ...
      if (matches == Prolog.Nil || !a3.unify(matches, engine.trail)) {
        return engine.fail();
      }
      return engine.cont;
    }
